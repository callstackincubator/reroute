...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  function Home(Props) {
    return React.createElement("div", void 0, React.createElement("h1", void 0, "Home"), React.createElement("p", void 0, "Welcome to the home page!"));
  }
  var make = Home;

  // examples/Admin.bs.js
  var React2 = __toModule(require_react());
  function Admin(Props) {
    return React2.createElement("div", void 0, React2.createElement("h1", void 0, "Admin"), React2.createElement("p", void 0, "This is an admin page"));
  }
  var make2 = Admin;
  ...
  function CreateRouter(Config) {
    var ReRoute$CreateRouter$Container = function(Props) {
      ...
      var match = React4.useReducer(function(_state, action) {
        return action._0;
      }, _1(Config.routeFromUrl, dangerouslyGetInitialUrl(void 0)));
      var dispatch = match[1];
      React4.useEffect(function() {
        var watcherID = watchUrl(function(url2) {
          return _1(dispatch, {
            _0: _1(Config.routeFromUrl, url2)
          });
        });
        return function(param) {
    ...
    var ReRoute$CreateRouter$Link = function(Props) {
      ...
      var children = Props.children;
      var href = _1(Config.routeToUrl, route);
      return React4.createElement("a", {
        href,
  ...
  // examples/NotFound.bs.js
  var React5 = __toModule(require_react());
  function NotFound(Props) {
    return React5.createElement("div", void 0, React5.createElement("h1", void 0, "We are sorry..."), React5.createElement("p", void 0, "Unfortunately we could not find the page you were looking for."), React5.createElement("p", void 0, "Use the above menu to navigate to other pages :)"));
  }
  var make3 = NotFound;

  // examples/App.bs.js
  function routeFromUrl(url2) {
    var match = url2.path;
    if (match) {
  ...
  function App(Props) {
    return React6.createElement(Router.Container.make, {
      children: function(currentRoute) {
        var tmp;
        switch (currentRoute) {
          case 0:
            tmp = React6.createElement(make2, {});
            break;
          case 1:
            tmp = React6.createElement(make, {});
            break;
          case 2:
            tmp = React6.createElement(make3, {});
            break;
        }
        return React6.createElement("div", void 0, React6.createElement("ul", void 0, React6.createElement("h3", void 0, "Menu"), React6.createElement(Router.Link.make, {
          route: 1,
          children: React6.createElement("li", void 0, "Home")
        }), React6.createElement(Router.Link.make, {
          route: 0,
          children: React6.createElement("li", void 0, "Admin")
        })), tmp);
      }
    });
  }
  ...
  // examples/index.bs.js
  require_();
  renderToElementWithId(React8.createElement(make4, {}), "root");
})();
